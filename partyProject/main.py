...
class Interface(tk.Frame):
    ...
    def page3(self):
        ...
        order_button = tk.Button(user_info_frame, text='New Order', width=10, height=5, command=self.page4)
        order_button.grid(row=0, column=0)

        profile_button = tk.Button(user_info_frame, text='My Profile', width=10, height=5, command=self.page6)
        profile_button.grid(row=0, column=1)

        my_orders_button = tk.Button(user_info_frame, text='My Orders', width=10, height=5, command=self.page5)
        my_orders_button.grid(row=0, column=2)

        billing_button = tk.Button(user_info_frame, text='Billing', width=10, height=5)
...
# TABLE TO DISPLAY ORDER HISTORY
    ...
    def page6(self):
        ...
        profile = data.get_profile(self.USER)
        ...
        register_button = tk.Button(user_info_frame, text="Update", bg=self.colour1, command= lambda user=self.USER:
