...
class Interface(tk.Frame):
    ...
    def page2(self):
        ...
        def login_user():
            if authenticate.check_password(username_textbox.get().strip(),password_textbox.get().strip()):
        ...
        login_button = tk.Button(user_info_frame, text="Login", bg=self.colour1, command=login_user)
        login_button.grid(row=2, column=1, sticky='news', columnspan=3)
    ...
    def page3(self):
        ...
        order_button = tk.Button(user_info_frame, text='New Order', width=10, height=5)
        order_button.grid(row=0, column=0)

        profile_button = tk.Button(user_info_frame, text='My Profile', width=10, height=5)
        profile_button.grid(row=0, column=1)

        my_orders_button = tk.Button(user_info_frame, text='My Orders', width=10, height=5)
    ...
    def page4(self):
        ...
        pax_label = tk.Label(user_info_frame, text="No. of Pax:")
        pax_label.grid(row=0, column=4, sticky=tk.W)
        number_of_people = []
        for i in range(50):
            number_of_people.append(i)
        pax_picker = ttk.Combobox(user_info_frame, values=number_of_people)
        pax_picker.grid(row=0,column=5,sticky=tk.W)
        ...
        package_picker = ttk.Combobox(user_info_frame, values=packages)
        package_picker.grid(row=2,column=0,sticky=tk.W)
